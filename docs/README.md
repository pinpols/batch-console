...
| [Batch Console 重设计实施准备](../design/frontend-redesign-implementation-plan.md) | 2026-07 最新重设计定稿、IA v3、Phase 拆分、后端菜单同步与验收门禁 |
...
> CLAUDE.md 规范条款本身的变化(结构 / 构建 / 架构约束 / 编码红线 / i18n / 测试范围)记在 [`changelog.md`](./changelog.md),日期倒序。
