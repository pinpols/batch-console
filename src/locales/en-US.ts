...
const messages: Messages = {
  ...
  apiError: {
    ...
    permissionDeniedMessage: 'You do not have permission to access this feature.',
    missingJobCodeTitle: 'Missing parameter (jobCode)',
    missingJobCodeMessage:
  ...
  fetchAllPageItems: {
    truncated:
      'This list is showing only the first {shown} / {total} records. Narrow the filters or wait for server-side pagination migration.',
  },
  workflowDesigner: {
  ...
  workflowDesignerMvp: {
    ...
    gatewayPassThroughHint: 'This is not a multi-upstream join, so no join mode is required.',
    joinModeDescription: {
      ALL: 'Trigger downstream after every upstream dependency is satisfied.',
      ANY: 'Trigger downstream after any upstream dependency is satisfied.',
      N_OF: 'Trigger downstream after the configured number of dependencies is satisfied.',
    },
    pipelineCodeUnset: 'no pipeline',
    approvalTemplateUnset: 'no template',
    inspectorTitle: 'Properties',
    inspectorAriaLabel: 'Workflow element properties panel',
    readonlyTag: 'Read-only',
    ...
    dependencyPickerPlaceholder: 'Select a dependency edge',
    dependencyPickerAria: 'Dependency edge picker',
    saveOk: 'Saved',
    ...
    field: {
      ...
      conditionExprPlaceholder: 'e.g. status == "READY"',
      edgeEnabled: 'Enabled',
    },
    edgeTypeDescription: {
      SUCCESS: 'Triggers downstream only when the upstream node succeeds.',
      FAILURE: 'Triggers downstream only when the upstream node fails; use for recovery or alerts.',
      CONDITION: 'Triggers downstream when upstream succeeds and the expression evaluates to true.',
      ALWAYS:
        'Triggers after upstream succeeds or fails; skipped upstream nodes do not trigger it.',
    },
    conditionExprHelp:
      'Reference upstream sourcePayload fields directly without template wrapping; supports AND, OR, !, comparisons, in, contains, startsWith, and endsWith.',
    disabledEdgeHint: 'Disabled dependencies do not participate in execution.',
    edgeLegendAria: 'Edge type legend',
    layout: {
      expandPalette: 'Expand node palette',
      collapsePalette: 'Collapse node palette',
      openInspector: 'Open properties panel',
      closeInspector: 'Close properties panel',
      enterFocusMode: 'Focus canvas',
      exitFocusMode: 'Exit canvas focus',
    },
    validation: {
      ...
      joinModeRequired: 'A multi-upstream GATEWAY requires a join mode',
      joinThresholdRange: 'Required count must be an integer from 1 to {count}',
  ...
  tenantPackageImportWizard: {
    ...
    btnDownloadSampleTemplate: 'Download sample template',
    btnExportCurrent: 'Export current package',
    btnFieldGuide: 'Field guide',
    sampleTemplateDownloadedToast: 'Sample template downloaded',
    scenarioPlaceholder: 'Sample scenario',
    ...
    guideFilterAll: 'All',
    guideFilterRequired: 'Required',
    guideFilterCommon: 'Common',
    guideFilterAdvanced: 'Advanced',
    guideRequired: 'Required',
    guideOptional: 'Optional',
    guideReadOnly: 'Read-only',
    guideColColumn: 'Column',
    guideColLevel: 'Level',
    guideColFormat: 'Type',
    guideColDefault: 'Default / empty behavior',
    guideColDescription: 'Description',
    guideColAllowed: 'Allowed values',
    guideColExample: 'Example',
    guideColFillExample: 'Copyable example',
    guideColAppliesTo: 'Applies to',
  ...
  nav: {
    ...
    tenant: 'Tenant',
    tenantCurrent: 'Current tenant',
    tenantSwitcherAria: 'Current tenant switcher',
  ...
  page: {
    ...
    observabilityLineage: {
      ...
      description:
        'Query evidence chains by result_version or businessKey and verify asset partition readiness.',
    },
    systemNotifications: {
      title: 'Notifications',
    ...
    opsCapacityProfile: {
      ...
      description:
        'Aggregate runtime duration, throughput and file volume by tenant, job or worker.',
    },
    opsAssetFreshness: {
      title: 'Asset freshness policies',
      description: 'Manage JOB asset freshness SLA policies for missing and stale alerts.',
    },
  ...
  pipelineDefinitionList: {
    ...
    typeLabel: 'Type',
    typePlaceholder: 'Select pipeline type',
    enabledLabel: 'Enabled',
    enabledPlaceholder: 'All',
    optEnabled: 'Enabled',
    optDisabled: 'Disabled',
  ...
  batchDayList: {
    ...
    viewTable: 'Detail table',
    calendarSummary: 'Monthly batch-day summary',
    metricDays: 'Days with data',
    metricJobs: 'Planned jobs',
    metricFailed: 'Failed jobs',
    metricInFlightLate: 'In flight / Late',
    calendarCellCounts: 'Success {success} · Failed {failed} · Running {running}',
    calendarCellLate: '{n} late',
    calendarCellEmpty: 'No batch data',
    emptyMonthTitle: 'No batch data for this month',
    emptyMonthDescription: 'Switch months or open the detail table to query a date range.',
    loadFailed: 'Failed to load batch days. Please retry.',
  ...
  batchDayReplay: {
    ...
    fieldCandidateSource: 'Candidate source',
    modeReplay: 'Replay',
    modeDryRun: 'Side-effect-free dry-run',
    sourceExisting: 'Existing instances',
    sourcePlan: 'Schedule plan',
    fieldScope: 'Scope',
    ...
    configPolicyUseLatest: 'Use latest config',
    configPolicyUseSpecified: 'Use a specified version',
  ...
  capacityProfile: {
    ...
    groupByTenant: 'Tenant',
    groupByJob: 'Job',
    groupByWorker: 'Worker',
    limitLabel: 'Rows',
    windowLabel: 'Time window',
    fromPlaceholder: 'Start time',
    toPlaceholder: 'End time',
    metricInstances: 'Instances',
    metricInstancesDesc: 'Runs in the selected window',
    metricTasks: 'Tasks',
    metricTasksDesc: 'Task executions in the window',
    metricDuration: 'Total duration',
    metricDurationDesc: 'Accumulated run duration',
    metricBytes: 'File volume',
    metricBytesDesc: 'Processed file bytes',
    trendTitle: 'Workload trend',
    rankingTitle: 'Throughput ranking (records/s)',
    recordsPerSecondUnit: 'records/s',
    p95Title: 'Average latency vs P95',
    resultTitle: 'Capacity profile detail',
    resultHint: 'Use charts to spot trends and anomalies, then expand the table for exact values.',
    detailToggle: 'Expand capacity details',
    dimensionTenant: 'Tenant',
    dimensionJob: 'Job Code',
    ...
    colBytes: 'Bytes',
    colRecords: 'Records',
    colRecordsRate: 'Records/s',
    colMbRate: 'MB/s',
    coverageTitle: 'Coverage',
    loadOk: 'Capacity profile refreshed',
    loadFailed: 'Failed to load capacity profile',
    emptyHint: 'No capacity profile data yet. Adjust the time window or grouping, then refresh.',
  },
  assetFreshness: {
    refresh: 'Refresh',
    create: 'New policy',
    createTitle: 'New freshness policy',
    editTitle: 'Edit freshness policy',
    assetCode: 'Asset code',
    assetCodePlaceholder: 'Enter Job Code',
    ...
    enabled: 'Enabled',
    enabledAll: 'All',
    required: 'Enter asset code and expected time',
    loadFailed: 'Failed to load freshness policies',
    saveOk: 'Policy saved',
    toggleOk: 'Policy status updated',
  },
  lineageEvidence: {
    refresh: 'Refresh',
    tabEvidence: 'Evidence chain',
    tabReadiness: 'Partition readiness',
    queryMode: 'Query mode',
    modeBusinessKey: 'Business Key',
    modeResultVersion: 'Result Version',
    businessKeyLabel: 'Business Key',
    businessKeyPlaceholder: 'Enter business key',
    resultVersionIdLabel: 'Result Version ID',
    metricScope: 'Scope',
    metricScopeDesc: 'Evidence query scope',
    metricPipelines: 'Pipeline instances',
    metricPipelinesDesc: 'Related pipeline_instance',
    metricFiles: 'File records',
    metricFilesDesc: 'Related file_record',
    metricDispatches: 'Dispatch records',
    metricDispatchesDesc: 'Related dispatch_record',
    resultVersionTitle: 'Result Version',
    jobInstanceTitle: 'Job instance',
    coverageTitle: 'Coverage',
    relatedRowsTitle: 'Related records',
    pipelineInstances: 'Pipeline instances',
    fileRecords: 'File records',
    dispatchRecords: 'Dispatch records',
    jobCodeLabel: 'Job Code',
    jobCodePlaceholder: 'Enter jobCode',
    ...
    businessKeyRequired: 'Enter Business Key',
    resultVersionRequired: 'Enter Result Version ID',
    readinessRequired: 'Enter Job Code and biz date',
    loadOk: 'Query completed',
  },
  batchDayWindow: {
  ...
  workflowDefinitionList: {
    ...
    optDisabled: 'Disabled',
    typeLabel: 'Type',
    typePlaceholder: 'Select workflow type',
  ...
  observability: {
    ...
    eventCatalogViewExplorer: 'Catalog view',
    eventCatalogViewDense: 'Dense table',
    eventCatalogEmptyTitle: 'No matching catalog items',
    eventCatalogEmptyDescription: 'Adjust the keyword or refresh the catalog.',
    eventCatalogSelectTitle: 'Select a catalog item',
    eventCatalogSelectDescription:
      'Select an event type or topic on the left to inspect its definition.',
    eventCatalogSchemaTitle: 'Schema definition',
    eventCatalogDescriptionMissing: 'No description is registered.',
    eventCatalogCategoryMissing: 'Category not registered',
    eventCatalogSchemaMissingTitle: 'Schema not registered',
    eventCatalogSchemaMissingDescription:
      'This event type does not currently have a schema definition to display.',
    ...
    outboxEmptyTitle: 'No outbox events',
    outboxRetryEmptyDescription: 'No pending or active retries match the current scope.',
    outboxDeliveryEmptyDescription: 'No delivery records match the current scope.',
  ...
  monitor: {
    ...
    detailRetryFailedPartitionsTarget: 'failed partitions of instance "{no}"',
    detailRetryFailedPartitionsConsequence:
      'Only failed partitions under this run are retried; successful partitions are not repeated. Confirm downstream idempotency and input validity first.',
    detailRetryFailedPartitionsDisabled:
      'Only failed or partially failed runs can retry failed partitions',
    detailRetryFailedPartitionsOk: 'Failed partition retry submitted',
    detailDiagnosisSection: 'Diagnostic result',
    detailDiagnosisEmpty: 'No diagnostic result yet',
  ...
  arrivalGroupList: {
    metricProgress: 'File arrival progress',
    metricProgressDesc: '{arrived} arrived, {waiting} waiting',
    metricReady: 'Ready groups',
    metricReadyDesc: '{total} groups total',
    metricWaiting: 'Waiting groups',
    metricWaitingDesc: 'Includes WAITING and PARTIAL',
    metricTimeout: 'Timed-out groups',
    metricTimeoutDesc: '{files} timed-out files in total',
    groupCodeLabel: 'Group code',
    groupCodePlaceholder: 'Search group code',
    stateLabel: 'Arrival state',
    statePlaceholder: 'All arrival states',
  ...
  jsonTextareaInput: {
    ...
    validPrefix: 'Valid JSON',
    placeholder: 'Drop a .json file / click "Choose file" / ⌘V paste / type directly',
    expectArray: 'Root JSON must be an array',
    expectObject: 'Root JSON must be an object',
    summaryArray: '{n} array item(s)',
    summaryObject: '{n} object field(s)',
    summaryValue: '{type} value',
    onlyJsonFile: 'Only .json files are supported. Current: {name}',
    unknownFile: 'unknown',
    fileTooLarge: 'File exceeds {mb} MB. Reduce it before importing.',
    loaded: 'Loaded {name}',
  ...
  triggerList: {
    ...
    registerConfirmVerb: 'Register',
    confirmTarget: 'trigger "{code}"',
    registerConfirmConsequence: 'The trigger will be registered with the scheduler',
    registerConfirmButton: 'Confirm register',
    registerSuccess: 'Registered',
    unregisterTitle: 'Confirm unregister',
    unregisterText: 'Unregister trigger {code}?',
    unregisterConfirmVerb: 'Unregister',
    unregisterConfirmConsequence: 'The trigger will be removed from the scheduler',
    unregisterConfirmButton: 'Confirm unregister',
    unregisterSuccess: 'Unregistered',
    pauseTitle: 'Confirm pause',
    pauseText: 'Pause trigger {code}?',
    pauseConfirmVerb: 'Pause',
    pauseConfirmConsequence: 'You can resume or enable it again from the list',
    pauseConfirmButton: 'Confirm pause',
    pauseSuccess: 'Paused',
  ...
  userAccountList: {
    ...
    statusAll: 'All accounts',
    monitorTitle: 'Account list',
    monitorSubtitle: 'Manual refresh',
    emptyTitle: 'No login accounts',
    emptyDescription: 'No accounts on this page match the status or keyword filters.',
  ...
  workerManagement: {
    ...
    emptyTitle: 'No workers registered for this tenant',
    emptyDescription:
      'Tenant {tenant} has no worker heartbeats. Confirm worker-dispatch / worker-import / worker-export / worker-process / worker-atomic are running and registered to this tenant.',
    emptyFiltered: 'No workers match the current filters',
    emptyLastRefresh: 'Last refreshed: {time}',
  ...
  configReleaseList: {
    ...
    restartRequired: 'Rolling restart required',
    applyConfirmationStatus: 'Instance confirmation',
    governanceCatalog: 'Configuration catalog',
    governanceClass: 'Configuration class',
    governancePrefix: 'Configuration prefix',
    governanceSensitivity: 'Sensitivity',
    ...
    createNameLabel: 'Config name',
    createPayloadLabel: 'Configuration payload',
    createPayloadPlaceholder: 'Enter a JSON object matching the configuration type',
    createNamePlaceholder: 'e.g. Daily settlement job config',
    ...
    ruleCreateName: 'Config name is required',
    ruleCreatePayload: 'Configuration payload is required',
    ruleCreatePayloadJson: 'Configuration payload must be valid JSON',
    ruleCreatePayloadObject: 'Configuration payload must be a JSON object',
    configSourceEnum: {
      STATIC: 'Static config',
      DYNAMIC_DB: 'Dynamic DB config',
    },
    activationEnum: {
      RESTART_REQUIRED: 'Effective after rolling restart',
      IMMEDIATE_AFTER_CONFIRMATION: 'Effective after confirmation',
    },
    sensitivityEnum: {
      PUBLIC: 'Public',
      SECRET: 'Sensitive',
  ...
  jobDefinitionList: {
    ...
    createJobTypePlaceholder: 'Select job type',
  ...
  jobDefinitionWizard: {
    pageTitle: 'Create Job Wizard',
    pageDescription:
      'Create a job step by step across job, schedule, resources, triggers, and related config.',
    importBundleJson: 'Import Bundle JSON',
    prefillDialogTitle: 'Prefill Wizard from Bundle JSON',
    prefillSourcePrefix: 'Bundle source:',
    prefillSourceJobList: 'Job list',
    prefillSourceMiddle: ' → any job row action menu → ',
    prefillExportBundle: 'Export Bundle',
    prefillSourceSuffix: ', which downloads ',
    prefillSourceHint:
      'Paste the content into the text area below to prefill all steps at once (jobDefinitions / fileChannels / fileTemplates / workflowDefinitions / alertRoutings). You can still edit each step after prefill.',
    prefillConfirm: 'Prefill wizard',
    filesHint:
      'IMPORT/EXPORT jobs can bind existing fileChannels / fileTemplates or create new ones from pasted JSON arrays. Both sources are merged at submit.',
    workflowHint:
      'WORKFLOW jobs can link existing workflow_definitions or create them transactionally from a JSON array.',
    alertsHint:
      'Select existing alert_routing entries or create them transactionally from a JSON array. Leave empty to create only the job definition.',
    prevStep: 'Previous',
    nextStep: 'Next',
    submitCreate: 'Create',
    stepBasicTitle: 'Basic',
    stepBasicDesc: 'Set the unique job identity and base attributes',
    stepScheduleTitle: 'Schedule',
    stepScheduleDesc: 'Configure cadence, Cron, and timezone',
    stepResourceTitle: 'Resources',
    stepResourceDesc: 'Choose execution queue, worker group, and quotas',
    stepTriggerTitle: 'Trigger',
    stepTriggerDesc: 'Set default params, param schema, and trigger behavior',
    stepFilesTitle: 'Related Files',
    stepFilesDesc: 'Bind IMPORT / EXPORT channels and templates',
    stepWorkflowTitle: 'Workflow',
    stepWorkflowDesc: 'Bind WORKFLOW jobs to workflow definitions',
    stepAlertsTitle: 'Alerts',
    stepAlertsDesc: 'Match tenant alert routing (optional)',
    stepReviewTitle: 'Review',
    stepReviewDesc: 'Review all inputs before submitting',
    bundlePrefillJsonPlaceholder: 'Drop a job-bundle-*.json, pick a file, or paste / type the JSON',
    errJsonInvalid: 'Invalid JSON',
    errWatermarkRequired: 'INCREMENTAL mode requires watermarkField',
    errWatermarkPattern:
      'Only letters, digits, and underscores; must start with a letter or underscore',
    errScheduleExprRequired: 'Non-MANUAL schedules require scheduleExpr',
    errJobCodeRequired: 'Enter job code',
    errJobCodePattern: 'Start with a letter; letters/digits/underscore/hyphen only; max 128',
    errJobNameRequired: 'Enter job name',
    errJobTypeRequired: 'Select job type',
    errScheduleTypeRequired: 'Select schedule type',
    errExecutionModeRequired: 'Select execution mode',
    errJsonMustBeArray: 'JSON must be an array',
    countFormatError: 'Invalid format',
    countCreate: 'Create {n}',
    countRef: 'Reference {n}',
    countRefAndCreate: 'Reference {ref} + create {create}',
    prefillSuccess: 'Bundle JSON prefilled',
    prefillBadJson: 'Invalid Bundle JSON',
    createBundleSuccess: 'Job Bundle created',
    relatedJsonInvalid: 'Related config JSON is invalid',
  ...
  jobConfigBasic: {
    ...
    fieldWatermark: 'Watermark field',
    fieldScheduleType: 'Schedule type',
    fieldScheduleExpr: 'Schedule expression',
    fieldQueueCode: 'Queue code',
    fieldWorkerGroup: 'Worker group',
    fieldTimezone: 'Timezone',
  ...
  alertList: {
    ...
    tabAcked: 'Acked',
    tabAll: 'All',
    actionSilence24: 'Silence 24h',
    ackedBadge: 'Acked',
    emptyGroup: 'No alerts in this group',
    emptyDescription: 'There are no alert events requiring attention in this group.',
    tracePlaceholder: 'Search Trace ID',
    severityLabel: 'Severity',
    severityPlaceholder: 'Select severity',
    typeLabel: 'Type',
    typePlaceholder: 'Select alert type',
    statusLabel: 'Status',
    statusPlaceholder: 'All statuses',
    traceLabel: 'Trace',
  ...
  approvals: {
    ...
    statusPlaceholder: 'All statuses',
    typeLabel: 'Type',
    typePlaceholder: 'Search approval type',
    keywordLabel: 'Keyword',
    ...
    emptyTitle: 'No approval records for this tenant',
  ...
  workerFingerprintBoard: {
    ...
    metricDrifted: 'Version drift',
    metricDriftedDesc: 'Active workers outside the dominant fingerprint',
    metricAvailability: 'Online / draining',
    metricAvailabilityDesc: 'Current runtime availability',
    metricVersions: 'Active fingerprints',
    metricVersionsDesc: 'Build and SDK combinations',
  ...
  tenantList: {
    ...
    activateConfirmConsequence:
      "This tenant's triggers resume dispatching and users can log in again.",
  ...
  tenantCopyConfigDialog: {
    ...
    btnCopyPreview: 'Copy preview',
    btnOverlayPreview: 'Overlay preview',
    btnMatrix: 'Job matrix',
    btnRunFormal: 'Run copy',
    tabDiff: 'Diff preview',
    tabMatrix: 'Job matrix',
    metricTargets: 'Targets',
    metricAdd: 'Add',
    metricUpdate: 'Update',
    metricUnchanged: 'Unchanged',
    metricDeleteCandidate: 'Delete candidates',
    diffItemsTitle: 'Config item details',
    colTenant: 'Tenant',
    colAdd: 'Add',
    colUpdate: 'Update',
    colUnchanged: 'Unchanged',
    colDeleteCandidate: 'Delete candidates',
    colImpacts: 'Impacts',
    colConfigType: 'Config type',
    ...
    colQueue: 'Queue',
    colPipelines: 'Pipeline jobs',
    jobCodesRequiredForMatrix: 'Enter at least one jobCode before comparing the job matrix',
  ...
  configSecretsTab: {
    ...
    rotatePayloadTitle: 'Enter new secret payload',
    rotatePayloadPrompt:
      'Enter valid JSON. Only encrypted content is stored and it cannot be read back.',
    rotatePayloadRequired: 'Secret payload is required',
    rotatePayloadInvalid: 'Secret payload must be valid JSON',
  ...
  opsMetricGrid: {
    pendingApprovals: 'Pending approvals',
    pendingApprovalsDesc: 'Open approvals →',
    activeAlerts: 'Active alerts',
    activeAlertsDesc: 'View alerts →',
    criticalAlerts: 'Critical alerts',
    criticalAlertsDesc: 'View critical alerts →',
    runningInstances: 'Running instances',
    runningInstancesDesc: 'View running instances →',
    failedInstances: 'Failed instances',
    failedInstancesDesc: 'View failed instances →',
    slaViolations: 'SLA violations',
    slaViolationsDesc: 'View SLA instances →',
    onlineWorkers: 'Online workers',
    drainingWorkers: 'Draining workers',
    workerListDesc: 'View worker list →',
    offlineWorkers: 'Offline workers',
    outboxRetryBacklog: 'Outbox retry backlog',
    outboxRetryBacklogDesc: 'View Outbox list →',
    outboxDeliveryFailed: 'Outbox delivery failed',
    outboxDeliveryFailedDesc: 'View Outbox list →',
  },
  opsDistPanel: {
    title: 'Distribution',
