/**
 * Workflow 设计器 inspector — JOB 节点 jobCode 下拉选项。
 *
 * 调 BE PR #366 真路径 `GET /api/console/queries/job-definitions/codes?tenantId=`,
...
/** 仅供单测重置模块级缓存 */
export function __resetJobCodeCacheForTest() {
  cache = null
  inflight = null
}
